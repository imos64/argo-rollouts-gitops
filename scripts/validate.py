...
variant=objects((r/'variants/canary/workload.yaml').read_text())
schemas(variant)
rollout=next(o for o in variant if o['kind']=='Rollout')
assert [s['setWeight'] for s in rollout['spec']['strategy']['canary']['steps'] if 'setWeight' in s]==[25,50,100]
